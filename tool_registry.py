...
TOOLS: Dict[str, dict] = {
  ...
  # ---- Intelligence ----
    ...
    # ---- CommonHuman-Lab scanners ----
    "breachsql": {
        "desc": "SQL injection detection and exploitation — error, boolean, time-blind, union, OOB across all major backends",
    ...
    "stingxss": {
        "desc": "Context-aware XSS scanner — reflected, DOM, stored, blind, and browser-confirmed XSS with WAF evasion",
    ...
    "phaseaccess": {
        "desc": "IDOR/BOLA scanner — dual-session confirmed findings, auto-login, crawl, JWT tampering, OpenAPI import, HAR/Burp replay",
    ...
    "vaultrip": {
        "desc": "Post-exploitation credential harvesting — files, process memory, browsers, keyrings, Kerberos, offline dumps, SSH remote",

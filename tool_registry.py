...
TOOLS: Dict[str, dict] = {
 ...
 # ---- WiFi Pentest ----
    ...
    "gdb-peda": {
        "desc": "GDB with PEDA enhancement — pattern create/offset, ROP helpers",
        "endpoint": "/api/tools/gdb-peda",
        "method": "POST",
        "category": "binary",
        "params": {"binary": {"required": True}},
        "optional": {"commands": "", "attach_pid": 0, "core_file": "", "additional_args": ""},
        "effectiveness": 0.88,
    },
    ...
    "zap": {
        ...
        "category": "web_vuln",
        "params": {"target": {"required": True}},
        "optional": {"scan_type": "baseline", "api_key": "", "daemon": False, "port": "8090", "output_format": "xml", "additional_args": ""},
        "effectiveness": 0.88,
    },
    "burpsuite-alternative": {
        "desc": "Selenium-based Burp-style active/passive web scanner",
    ...
    "browser-agent": {
        "desc": "Headless browser agent — navigate, screenshot, proxy-assisted testing",
        "endpoint": "/api/tools/browser-agent",
        "method": "POST",
        "category": "web_vuln",
        "params": {"url": {"required": True}},
        "optional": {"action": "navigate", "headless": True, "wait_time": 5, "proxy_port": None, "active_tests": False},
        "effectiveness": 0.80,
    },
    "http-framework": {
        "desc": "Custom HTTP framework — request, spider, repeater, intruder actions",
        "endpoint": "/api/tools/http-framework",
        "method": "POST",
        "category": "web_vuln",
        "params": {"url": {"required": True}},
        "optional": {"action": "request", "method": "GET", "data": {}, "headers": {}, "cookies": {}, "max_depth": 3, "max_pages": 100},
        "effectiveness": 0.80,
    },

    # ---- API Security ----
    "api_fuzzer": {
        "desc": "Fuzz REST API endpoints with HTTP method and wordlist permutations",
    ...
    "volatility3": {
        "desc": "Memory forensics framework v3 — analyse RAM dumps (modern)",
    ...
    "cloudmapper": {
        "desc": "AWS account visualisation and security analysis",
        "endpoint": "/api/tools/cloudmapper",
        "method": "POST",
        "category": "cloud",
        "params": {"account": {"required": True}},
        "optional": {"action": "collect", "config": "config.json", "additional_args": ""},
        "effectiveness": 0.82,
    },
    "pacu": {
        "desc": "AWS exploitation framework — enumerate and attack AWS environments",
        "endpoint": "/api/tools/pacu",
        "method": "POST",
        "category": "cloud",
        "params": {},
        "optional": {"session_name": "hexstrike_session", "modules": "", "data_services": "", "regions": "", "additional_args": ""},
        "effectiveness": 0.85,
    },
    "clair": {
